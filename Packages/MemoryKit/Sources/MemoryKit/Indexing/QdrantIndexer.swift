...
extension UUID {
    ...
    /// Guaranteeing absolute idempotency across our index rebuilds.
...
public actor QdrantIndexer {
    ...
    public func indexPoint(_ point: QdrantPoint) async -> Bool {
        logger.debug(" Peering into mystical variables... Point ID: \(point.id)")
    ...
    public func index(
        ...
        let point = QdrantPoint(id: pointId, vector: qdrantVector, payload: payload)
